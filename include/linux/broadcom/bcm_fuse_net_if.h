...
#define BCM_NET_RIL_PDP_CNTXS_BASE\
 (BCM_NET_MAX_DUN_PDP_CNTXS + 1)	/*8 for now*/
#define BCM_NET_MAX_RIL_PDP_CNTXS\
 (BCM_NET_MAX_PDP_CNTXS - BCM_NET_MAX_DUN_PDP_CNTXS)
	/*RIL context id 8-10*/

/*due to the support for DUN, which requires to use cid starting from 0,*/
/*RIL now has cid range from 8-10*/
/* (BCM_NET_RIL_PDP_CNTXS_BASE - BCM_NET_MAX_PDP_CNTXS)*/
/*but android has hardcoded rmnet0 in several places, in order not to change*/
/*android code for later integration compliexity,*/
/* we map rmnet0-rmnet2 with cid 8-10*/
